...
PROVIDES = "coreutils"
SRC_URI = " \
	http://archive.raspbian.org/raspbian/pool/main/c/coreutils/coreutils_8.30-3_armhf.deb;unpack=0;name=deb0\
"
DEBFILENAME_coreutils = "coreutils_8.30-3_armhf.deb"
SRC_URI[deb0.sha256sum] = "6a578920fe016ce628065f4c7a2639a6ffc3d52637e4b4f20a46ea76fcc05539"
SRC_URI[deb0.md5sum] = "673f1b05c868f29b7d9470b45b3ca2ec"

RDEPENDS_${PN} = "libacl1 (>= 2.2.23) libattr1 (>= 1:2.4.44) libc6 (>= 2.28) libselinux1 (>= 2.1.13)"
...
FILES_${PN} = " \
    ...
    ./usr/bin/whoami \
    ./usr/bin/yes \
    ./usr/lib/arm-linux-gnueabihf/coreutils/libstdbuf.so \
    ./usr/sbin/chroot \

...
SRC_URI = " \
	http://archive.raspbian.org/raspbian/pool/main/p/python-defaults/libpython-stdlib_2.7.16-1_armhf.deb;unpack=0;name=deb0\
	http://archive.raspbian.org/raspbian/pool/main/p/python-defaults/libpython2-stdlib_2.7.16-1_armhf.deb;unpack=0;name=deb1\
	http://archive.raspbian.org/raspbian/pool/main/p/python-defaults/python_2.7.16-1_armhf.deb;unpack=0;name=deb2\
	http://archive.raspbian.org/raspbian/pool/main/p/python-defaults/python-minimal_2.7.16-1_armhf.deb;unpack=0;name=deb3\
	http://archive.raspbian.org/raspbian/pool/main/p/python-defaults/python2_2.7.16-1_armhf.deb;unpack=0;name=deb4\
	http://archive.raspbian.org/raspbian/pool/main/p/python-defaults/python2-minimal_2.7.16-1_armhf.deb;unpack=0;name=deb5\
"

...
SRC_URI = " \
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/libpython2.7-minimal_2.7.16-2+deb10u1_armhf.deb;unpack=0;name=deb0\
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/libpython2.7-stdlib_2.7.16-2+deb10u1_armhf.deb;unpack=0;name=deb1\
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/python2.7_2.7.16-2+deb10u1_armhf.deb;unpack=0;name=deb2\
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/python2.7-minimal_2.7.16-2+deb10u1_armhf.deb;unpack=0;name=deb3\
"
DEBFILENAME_libpython2.7-minimal = "libpython2.7-minimal_2.7.16-2+deb10u1_armhf.deb"
SRC_URI[deb0.sha256sum] = "e84407a0d58e7dff3adac497db1519dbdeba952a7caabd4f7ea2a14abb0e346d"
SRC_URI[deb0.md5sum] = "3517c1737b484d7f1a3bed020abf3274"
DEBFILENAME_libpython2.7-stdlib = "libpython2.7-stdlib_2.7.16-2+deb10u1_armhf.deb"
SRC_URI[deb1.sha256sum] = "dd2479f925a3da9b605b8dfb5a14ff58642e450252d7d4d99f05ca249c0d0280"
SRC_URI[deb1.md5sum] = "5c72c94d28f01c58647b9d38889637f0"
DEBFILENAME_python2.7 = "python2.7_2.7.16-2+deb10u1_armhf.deb"
SRC_URI[deb2.sha256sum] = "3bfd61bab2ede15a3deee14204a9227bce3f47ee782645729329154be40ccd03"
SRC_URI[deb2.md5sum] = "4b32ef51cb185f8df2e772cbfbb896f9"
DEBFILENAME_python2.7-minimal = "python2.7-minimal_2.7.16-2+deb10u1_armhf.deb"
SRC_URI[deb3.sha256sum] = "1c9370e55c7c01b33555c5fd4ca4597eb4b319ea7ca248fa113c32a25fe5822c"
SRC_URI[deb3.md5sum] = "316e8791bb364aebacd6ce9115908b4d"

RDEPENDS_lib${PN}-minimal = ""
RDEPENDS_lib${PN}-stdlib = "libbz2-1.0 libc6 (>= 2.28) libdb5.3 libexpat1 (>= 2.1~beta3) libffi6 (>= 3.0.4) libncursesw6 (>= 6) libpython2.7-minimal (= 2.7.16-2+deb10u1) libreadline7 (>= 7.0~beta) libsqlite3-0 (>= 3.5.9) libssl1.1 (>= 1.1.1) libtinfo6 (>= 6) mime-support"
RDEPENDS_${PN} = "libpython2.7-stdlib (= 2.7.16-2+deb10u1) mime-support python2.7-minimal (= 2.7.16-2+deb10u1)"
RDEPENDS_${PN}-minimal = "libc6 (>= 2.28) libpython2.7-minimal (= 2.7.16-2+deb10u1) zlib1g (>= 1:1.2.0)"

...
RDEPENDS_libqt4-help = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqt4-network (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqt4-sql (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtgui4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
RDEPENDS_libqt4-network = "libc6 (>= 2.15) libgcc1 (>= 1:4.4.0) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtdbus4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support zlib1g (>= 1:1.1.4)"
...
RDEPENDS_libqt4-script = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtdbus4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
RDEPENDS_libqt4-scripttools = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqt4-script (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtgui4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
RDEPENDS_libqt4-sql = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
RDEPENDS_libqt4-svg = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtgui4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support zlib1g (>= 1:1.1.4)"
RDEPENDS_libqt4-test = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
RDEPENDS_libqt4-xml = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
RDEPENDS_libqt4-xmlpatterns = "libc6 (>= 2.4) libgcc1 (>= 1:4.4.0) libqt4-network (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
...
RDEPENDS_libqtdbus4 = "libc6 (>= 2.4) libdbus-1-3 (>= 1.3.1) libgcc1 (>= 1:4.4.0) libqt4-xml (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libstdc++6 (>= 4.3.0) multiarch-support"
RDEPENDS_libqtgui4 = "fontconfig libaudio2 libc6 (>= 2.15) libfontconfig1 (>= 2.11) libfreetype6 (>= 2.3.5) libgcc1 (>= 1:4.4.0) libglib2.0-0 (>= 2.12.0) libice6 (>= 1:1.0.0) libjpeg62-turbo (>= 1.3.1) libmng1 (>= 1.0.10) libpng12-0 (>= 1.2.13-4) libqtcore4 (= 4:4.8.6+git64-g5dc8b2b+dfsg-3+deb8u2+rpi1) libsm6 libstdc++6 (>= 4.3.0) libtiff5 (>= 4.0.3) libx11-6 libxext6 libxrender1 multiarch-support zlib1g (>= 1:1.1.4)"

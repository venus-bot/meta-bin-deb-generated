...
SRC_URI = " \
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/libpython2.7-minimal_2.7.9-2_armhf.deb;unpack=0;name=deb0\
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/libpython2.7-stdlib_2.7.9-2_armhf.deb;unpack=0;name=deb1\
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/python2.7_2.7.9-2_armhf.deb;unpack=0;name=deb2\
	http://archive.raspbian.org/raspbian/pool/main/p/python2.7/python2.7-minimal_2.7.9-2_armhf.deb;unpack=0;name=deb3\
"
DEBFILENAME_libpython2.7-minimal = "libpython2.7-minimal_2.7.9-2_armhf.deb"
SRC_URI[deb0.sha256sum] = "03bb480a70b6b12184da72264d7a7acca1e60db99bd7ba2e004e8e21bba7819d"
SRC_URI[deb0.md5sum] = "a67418a44198811c5d2a4cbf74bbeee4"
DEBFILENAME_libpython2.7-stdlib = "libpython2.7-stdlib_2.7.9-2_armhf.deb"
SRC_URI[deb1.sha256sum] = "f3a3d402b18355cee19adb5018093bc2d60c4e02f758ad474b21dfc851167f19"
SRC_URI[deb1.md5sum] = "cc12f2f70f2b8cb5c3205a92c1df820a"
DEBFILENAME_python2.7 = "python2.7_2.7.9-2_armhf.deb"
SRC_URI[deb2.sha256sum] = "607286cb7610afe465a09f891c3a82ec7456afac8bd49ac75349e694cf745b23"
SRC_URI[deb2.md5sum] = "ce579875e3e299fada40204d36790bd9"
DEBFILENAME_python2.7-minimal = "python2.7-minimal_2.7.9-2_armhf.deb"
SRC_URI[deb3.sha256sum] = "4ce5cc375e3d844439a5ae305869c8f274094ef180c59332fd749ea97ef2ee91"
SRC_URI[deb3.md5sum] = "ad2e82b82ad12c6985d09d3330fe4a5d"

RDEPENDS_lib${PN}-stdlib = "libpython2.7-minimal (= 2.7.9-2) mime-support libbz2-1.0 libc6 (>= 2.15) libdb5.3 libexpat1 (>= 2.1~beta3) libffi6 (>= 3.0.4) libncursesw5 (>= 5.6+20070908) libreadline6 (>= 6.0) libsqlite3-0 (>= 3.5.9) libssl1.0.0 (>= 1.0.1) libtinfo5"
RDEPENDS_${PN} = "python2.7-minimal (= 2.7.9-2) libpython2.7-stdlib (= 2.7.9-2) mime-support"
RDEPENDS_${PN}-minimal = "libpython2.7-minimal (= 2.7.9-2) zlib1g (>= 1:1.2.0)"

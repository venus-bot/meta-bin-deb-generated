...
SRC_URI = " \
	...
	http://ftp.de.debian.org/debian/pool/main/g/glib2.0/libglib2.0-bin_2.42.1-1+b1_armhf.deb;unpack=0;name=deb1\
	http://ftp.de.debian.org/debian/pool/main/g/glib2.0/libglib2.0-data_2.42.1-1_all.deb;unpack=0;name=deb2\
	http://ftp.de.debian.org/debian/pool/main/g/glib2.0/libglib2.0-dev_2.42.1-1+b1_armhf.deb;unpack=0;name=deb3\
"
...
DEBFILENAME_libglib2.0-bin = "libglib2.0-bin_2.42.1-1+b1_armhf.deb"
SRC_URI[deb1.sha256sum] = "dc86283234a0746b10c751563006066100d753b383406579e4e2f9bed24c50be"
SRC_URI[deb1.md5sum] = "042d67d69d78f00d7c5fb729e981ae04"
...
DEBFILENAME_libglib2.0-dev = "libglib2.0-dev_2.42.1-1+b1_armhf.deb"
SRC_URI[deb3.sha256sum] = "682d299e6bb0ce693baa6749a694d7fc9ec2c82e6acceab69598ab02810920ea"
SRC_URI[deb3.md5sum] = "a323c89d30a52fc447d4b0f3569f2803"

RDEPENDS_lib${PN}-0 = "libc6 (>= 2.17) libffi6 (>= 3.0.4) libpcre3 (>= 1:8.35) libselinux1 (>= 1.32) zlib1g (>= 1:1.2.2)"
RDEPENDS_lib${PN}-bin = "libc6 (>= 2.4) libelfg0 (>= 0.8.12) libglib2.0-0 (= 2.42.1-1+b1) libglib2.0-data"
RDEPENDS_lib${PN}-dev = "libc6 (>= 2.4) libglib2.0-0 (= 2.42.1-1+b1) python (>= 2.6.6-7~) libglib2.0-bin (= 2.42.1-1+b1) libpcre3-dev (>= 1:8.31)  zlib1g-dev"
DEPENDS = " python libselinux1 libpcre3-dev libffi6 libpcre3 zlib1g libc6 zlib1g-dev libelfg0"
...
FILES_libglib2.0-bin = " \
	...
	./usr/share/doc/libglib2.0-bin/changelog.Debian.armhf.gz\
"
...
FILES_libglib2.0-dev = " \
	...
	./usr/share/doc/libglib2.0-dev/changelog.Debian.armhf.gz \

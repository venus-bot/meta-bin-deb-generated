...
RDEPENDS_lib${PN}-gobject2 = "libc6 (>= 2.4) libcairo2 (>= 1.10.0) libglib2.0-0 (>= 2.14.0) multiarch-support"
RDEPENDS_lib${PN}2 = "libc6 (>= 2.11) libfontconfig1 (>= 2.11) libfreetype6 (>= 2.3.5) libpixman-1-0 (>= 0.30.0) libpng12-0 (>= 1.2.13-4) libx11-6 libxcb-render0 libxcb-shm0 libxcb1 (>= 1.6) libxext6 libxrender1 multiarch-support zlib1g (>= 1:1.1.4)"
DEPENDS = "libc6 libfontconfig1 libfreetype6 libglib2.0-0 libpixman-1-0 libpng12-0 libx11-6 libxcb-render0 libxcb-shm0 libxcb1 libxext6 libxrender1 multiarch-support zlib1g"

PACKAGES = "libglib2.0-0 libglib2.0-bin libglib2.0-data libglib2.0-dev"
...
SRC_URI = " \
	...
	http://archive.raspbian.org/raspbian/pool/main/g/glib2.0/libglib2.0-bin_2.33.12+really2.32.4-5_armhf.deb;unpack=0;name=deb1\
	http://archive.raspbian.org/raspbian/pool/main/g/glib2.0/libglib2.0-data_2.33.12+really2.32.4-5_all.deb;unpack=0;name=deb2\
	http://archive.raspbian.org/raspbian/pool/main/g/glib2.0/libglib2.0-dev_2.33.12+really2.32.4-5_armhf.deb;unpack=0;name=deb3\
"
...
DEBFILENAME_libglib2.0-bin = "libglib2.0-bin_2.33.12+really2.32.4-5_armhf.deb"
SRC_URI[deb1.sha256sum] = "6718ad4c73d93ef294a804827d0ba6b89d52f7659f2cf10ab983fbc98a4f2fad"
SRC_URI[deb1.md5sum] = "766fa84ec981bbe9ab6ce40d28a6a40c"
DEBFILENAME_libglib2.0-data = "libglib2.0-data_2.33.12+really2.32.4-5_all.deb"
SRC_URI[deb2.sha256sum] = "463b25f80ff0617e86b4d26ba9e6ccbdb3fec58fd6fe7f7a13609b608266db2d"
SRC_URI[deb2.md5sum] = "65db6eebe09cda1afd54f31d3ffae98d"
DEBFILENAME_libglib2.0-dev = "libglib2.0-dev_2.33.12+really2.32.4-5_armhf.deb"
SRC_URI[deb3.sha256sum] = "0508090fac893cba65d9a628d3a2eeeb5c54eae268ae64903652762616e80506"
SRC_URI[deb3.md5sum] = "26dd3e156b4bca838bfa7776005e6d7a"

RDEPENDS_lib${PN}-0 = "libc6 (>= 2.13-28) libffi5 (>= 3.0.9) libgcc1 (>= 1:4.4.0) libpcre3 (>= 8.10) libselinux1 (>= 1.32) zlib1g (>= 1:1.2.2)"
RDEPENDS_lib${PN}-bin = "libc6 (>= 2.13-28) libelf1 (>= 0.142) libgcc1 (>= 1:4.4.0) libglib2.0-0 (= 2.33.12+really2.32.4-5) libglib2.0-data"
RDEPENDS_lib${PN}-dev = "libc6 (>= 2.13-28) libglib2.0-0 (= 2.33.12+really2.32.4-5) libglib2.0-bin (= 2.33.12+really2.32.4-5) libpcre3-dev (>= 8.11)  zlib1g-dev"
DEPENDS = "libgcc1 libelf1 libffi5 libselinux1 libpcre3-dev libpcre3 zlib1g libc6 zlib1g-dev "
...
FILES_libglib2.0-dev = " \
	...
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/codegen_main.py \
	./usr/include/glib-2.0/gobject/gsourceclosure.h \
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/utils.py \
	...
	./usr/share/gdb/auto-load/libglib-2.0.so.0.3200.4-gdb.py \
	...
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/config.py \
	...
	./usr/share/gdb/auto-load/libgobject-2.0.so.0.3200.4-gdb.py \
	...
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/__init__.py \
	...
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/codegen_docbook.py \
	...
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/codegen.py \
	...
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/parser.py \
	...
	./usr/lib/arm-linux-gnueabihf/gdbus-2.0/codegen/dbustypes.py \

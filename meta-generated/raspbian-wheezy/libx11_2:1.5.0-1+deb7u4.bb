...
SRC_URI = " \
	http://archive.raspbian.org/raspbian/pool/main/libx/libx11/libx11-6_1.5.0-1+deb7u4_armhf.deb;unpack=0;name=deb0\
	http://archive.raspbian.org/raspbian/pool/main/libx/libx11/libx11-data_1.5.0-1+deb7u4_all.deb;unpack=0;name=deb1\
	http://archive.raspbian.org/raspbian/pool/main/libx/libx11/libx11-dev_1.5.0-1+deb7u4_armhf.deb;unpack=0;name=deb2\
"
DEBFILENAME_libx11-6 = "libx11-6_1.5.0-1+deb7u4_armhf.deb"
SRC_URI[deb0.sha256sum] = "98a380d820dc4bd83e6fc46aeedae4174dc08afadeddc43d4020becf9369facd"
SRC_URI[deb0.md5sum] = "43e5ed253341908304eeed920f60e83a"
DEBFILENAME_libx11-data = "libx11-data_1.5.0-1+deb7u4_all.deb"
SRC_URI[deb1.sha256sum] = "c33a72cc2e5aec4d7049fd7b7595588e3231d12adfbf30f7178d4100d7bdae4f"
SRC_URI[deb1.md5sum] = "cff3f93c17cfe3121ef791c98ab3d7e1"
DEBFILENAME_libx11-dev = "libx11-dev_1.5.0-1+deb7u4_armhf.deb"
SRC_URI[deb2.sha256sum] = "10de53011f18a48b7b3547c28d650d2a779843d4a7409a3f3824a174638f7b7e"
SRC_URI[deb2.md5sum] = "b072e3e2b353f06e70fea2e8425fc4f5"

RDEPENDS_${PN}-6 = "libc6 (>= 2.13-28) libxcb1 (>= 1.2) libx11-data"
RDEPENDS_${PN}-dev = "libx11-6 (= 2:1.5.0-1+deb7u4) libxau-dev (>= 1:1.0.0-1) libxdmcp-dev (>= 1:1.0.0-1) x11proto-core-dev (>= 6.8.99.8-1) x11proto-input-dev x11proto-kb-dev xtrans-dev libxcb1-dev"

...
SRC_URI = " \
	http://archive.raspbian.org/raspbian/pool/main/b/boost-defaults/libboost-program-options-dev_1.49.0.1_armhf.deb;unpack=0;name=deb0\
	http://archive.raspbian.org/raspbian/pool/main/b/boost-defaults/libboost-regex-dev_1.49.0.1_armhf.deb;unpack=0;name=deb1\
	http://archive.raspbian.org/raspbian/pool/main/b/boost-defaults/libboost-system-dev_1.49.0.1_armhf.deb;unpack=0;name=deb2\
...
SRC_URI[deb0.sha256sum] = "dd406ef9a686d3e8c33d5726564124ea883229f9f381c7c9d8ca46328e5664ea"
SRC_URI[deb0.md5sum] = "06db7c962e03cb56d7a6d680f88f1ecb"
DEBFILENAME_libboost-regex-dev = "libboost-regex-dev_1.49.0.1_armhf.deb"
SRC_URI[deb1.sha256sum] = "a9e137ddf75294b8ead33e8b6ab84e15ab8d8265aef6a511169edfc2be52418c"
SRC_URI[deb1.md5sum] = "0f57a457a9db3e13d5420b812b61b464"
DEBFILENAME_libboost-system-dev = "libboost-system-dev_1.49.0.1_armhf.deb"
SRC_URI[deb2.sha256sum] = "d1d27c408afa2e31df1a721459f44b7128a70cc05e236e38bd6b653fdc174163"
SRC_URI[deb2.md5sum] = "3f969d6546f278755d7d5197c7e69798"
...
RDEPENDS_lib${PN}-program-options-dev = "libboost-program-options1.49-dev"
RDEPENDS_lib${PN}-regex-dev = "libboost-regex1.49-dev"
RDEPENDS_lib${PN}-system-dev = "libboost-system1.49-dev"
RDEPENDS_lib${PN}-thread-dev = "libboost-thread1.49-dev"

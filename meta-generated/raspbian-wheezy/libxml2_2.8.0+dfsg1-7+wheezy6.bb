...
SRC_URI = " \
	...
	http://archive.raspbian.org/raspbian/pool/main/libx/libxml2/libxml2-dev_2.8.0+dfsg1-7+wheezy6_armhf.deb;unpack=0;name=deb1\
"
...
DEBFILENAME_libxml2-dev = "libxml2-dev_2.8.0+dfsg1-7+wheezy6_armhf.deb"
SRC_URI[deb1.sha256sum] = "9e6802426b4b45b5be9677193535d5418a36623d4414eaa1a474fcf808c79f7a"
SRC_URI[deb1.md5sum] = "e70bc7e6b0ac0f3a95060457c6ace7c2"

RDEPENDS_${PN} = "libc6 (>= 2.13-28) liblzma5 (>= 5.1.1alpha+20120614) zlib1g (>= 1:1.2.3.3)"
RDEPENDS_${PN}-dev = "libxml2 (= 2.8.0+dfsg1-7+wheezy6)"
